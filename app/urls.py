...
urlpatterns = [
    path("users", CreateUserView.as_view(), name="add-user"),
    path("user/update/<str:first_name>", UpdateUserView.as_view(), name="update-user"),
    path("user/delete/<str:first_name>", DeleteUserView.as_view(), name="delete-user"),
    ...
    path("investor", CreateInvestorView.as_view(), name="add-investor"),
    path("investor/update/<str:first_name>", UpdateInvestorView.as_view(), name="update-investor"),
    path("investor/delete/<str:first_name>", DeleteInvestorView.as_view(), name="delete-investor"),
